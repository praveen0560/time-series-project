...
def evaluate_model(oriinal_price, differencing_order):
    train_data, test_data =oriinal_price[:-30], oriinal_price[-30:]
...
def inverse_scaling(scaler, scaled_data):
    # Fixed: inverse_transform (r before the m)
    # Fixed: reshape (s before the h)
